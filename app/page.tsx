...
function WhatsAppBtn({ phone = "917222805555", message = "", label = "WhatsApp Us", style = {} }) {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#faf9f7", color: "#1a1a1a", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <WhatsAppBtn phone="917222805555" label="Get a Quote" style={{ fontSize: 13, padding: "8px 18px" }} />
      </nav>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto", padding: "80px 40px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 14, alignItems: "center", flexWrap: "wrap" }}>
              <WhatsAppBtn phone="917222805555" message="Hi, I'm interested in wholesale fabrics from VLOOMS. Please share your catalog." label="WhatsApp for Catalog" />
      ...
      <section id="about" style={{ padding: "100px 40px", background: "#1a1a1a", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          <FadeIn>
            ...
            <a href="https://wa.me/917222805555?text=Hi, I want to visit your store. Please share timings." target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "#b8895a", fontWeight: 600, fontSize: 14, textDecoration: "none", borderBottom: "1px solid #b8895a", paddingBottom: 2 }}>
              Visit our store →
            </a>
          </FadeIn>
              ...
              <FadeIn key={fabric.id} delay={i * 0.04}>
                <div className="fabric-card">
                  ...
                  <div style={{ padding: "18px 20px" }}>
                    ...
                    <a className="wa-enquire" href={`https://wa.me/917222805555?text=Hi, I'm interested in ${fabric.name} from VLOOMS. Please share availability and wholesale rates.`} target="_blank" rel="noopener noreferrer">
        ...
        <FadeIn>
          <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
            ...
            <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
              <WhatsAppBtn phone="917222805555" message="Hi, I want to place a wholesale order. Please share your catalog and pricing." label="WhatsApp: 7222 80 5555" style={{ fontSize: 15, padding: "12px 28px" }} />
            ...
            <div style={{ background: "white", borderRadius: 20, padding: 36, border: "1px solid #f0ede8" }}>
              ...
              <button
                onClick={() => {
                  ...
                  window.open(`https://wa.me/917222805555?text=${encodeURIComponent(msg)}`, "_blank");
                }}
